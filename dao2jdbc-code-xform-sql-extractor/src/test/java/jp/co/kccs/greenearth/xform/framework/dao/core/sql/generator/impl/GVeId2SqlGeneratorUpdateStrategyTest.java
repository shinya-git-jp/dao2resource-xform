...
import jp.co.kccs.greenearth.xform.code.dao.core.sql.generator.impl.GVEMetadata2SqlExtractorUpdateStrategy;
 ...
 */
public abstract class GVeId2SqlGeneratorUpdateStrategyTest {
	protected String dbScheme;
	protected GDbCommonSetting dbCommonSetting;
	protected GVEMetadata2SqlExtractorUpdateStrategy updateStrategy = new GVEMetadata2SqlExtractorUpdateStrategy();
	...
	public void testCanGenerate() {
		cleanInsert("jp/co/kccs/greenearth/xform/code/dao/core/sql/generator/impl/GVeId2SqlGeneratorUpdateStrategyTest/import_cangenerate.xml");
		...
		assertFalse(updateStrategy.canGenerate(inqVirtualEntity));
		...
		assertTrue(updateStrategy.canGenerate(regVirtualEntity));
	}
	
	@Test
	public void testGenerate() {
		cleanInsert("jp/co/kccs/greenearth/xform/code/dao/core/sql/generator/impl/GVeId2SqlGeneratorUpdateStrategyTest/import_generate.xml");
		String veId = "1FEFE156727646DC9122045339BD3999";
		assertEquals("UPDATE " + dbScheme + ".jdbc_tool_test_pk_uk_mainmaster jdbc_tool_test_pk_uk_mainmaster " +
				"SET ItemCD=?,ItemNA=?,UnitPrice=?,SellPrice=?,Flag=?,PriceFlag=?,ExclusiveFG=?,RegisteredDT=?,UpdatedDT=? " +
				"WHERE jdbc_tool_test_pk_uk_mainmaster.objectID=?", updateStrategy.generate(veId));
	}
}
