...
import { InputTransformDialog } from "./entity-input-transform-dialog";
import { InputDialogPage } from "./entity-input-dialog";
...
export class InputListPage {
    ...
    async openInputPage() {
        ...
        await this.page.getByRole('button', { name: 'GEFーJDBCのエンティティファイル変換 GEF-DAO' }).click();
